...
// Badge component for live orders
...
const Dashboard = () => {
    ...
    // const { user } = useAuth();
    const tenant = { id: 'demo', name: 'Demo Restaurant' }; // Temporary mock
    const user = { displayName: 'Admin' }; // Temporary mock
    ...
    const liveOrders = mockLiveOrders; // Temporary mock
    const notifications = []; // Temporary mock
